Download all the files mentioned in the URL(Except "website1").
...
10. Click on "Inventory UI" site and then click browse. Navigate to localhost:<port>/HTML/HtmlPage.html

Note: "Source.zip" is source code for the project